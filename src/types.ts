 ...
 * to "this one output group": `groupLabel` (that group's label — auto-generated by joining its
 * tags' names with `groupTagLabelSeparator` in automatic mode, or the combo's own `label` in
 * manual mode), `patientTally` (count of every patient carrying this group's tags, regardless of
...
export interface ReportTemplate {
  ...
  /** Automatic mode only: joins an auto-generated group's tag names into its label, e.g. ", " for
   * "CD, Main". */
